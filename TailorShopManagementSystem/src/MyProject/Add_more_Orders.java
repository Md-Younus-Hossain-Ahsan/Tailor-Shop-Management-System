...
public final class Add_more_Orders extends javax.swing.JFrame {
    ...
    public Add_more_Orders() throws ClassNotFoundException{
        ...
        CustomerID.setText(Integer.toString(10001));
        Set_All_the_Data_through_CustomerID(10001);
    ...
    public Add_more_Orders(int Customer_ID) throws ClassNotFoundException{
    ...
    private void initComponents() {
        ...
        getContentPane().add(Add, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 560, 110, 40));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                try {
                    new Add_more_Orders().setVisible(true);
                } catch (ClassNotFoundException ex) {
                    Logger.getLogger(Add_more_Orders.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
        });
    }
